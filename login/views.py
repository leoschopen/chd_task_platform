...
def send_email(email, code):
    ...
    subject = '来自CHD-reward-platform的注册确认邮件'

    text_content = '''感谢注册CHD-reward-platform，这里是长安大学任务悬赏平台注册系统，\
                    如果你看到这条消息，说明你的邮箱服务器不提供HTML链接功能，请联系管理员！'''

    html_content = '''
                    <p>感谢注册<a href="http://{}/confirm/?code={}" target=blank>CHD-reward-platform</a></p>
                    <p>这里是长安大学任务悬赏平台注册系统</p>
                    <p>请点击站点链接完成注册确认！</p>
                    <p>此链接有效期为{}天！</p>
        ...
        if login_form.is_valid():
            try:
                ...
                if not user.has_confirmed:
                    message = '请前往您的邮箱' + user.stu_id + '@chd.edu.cn 进行确认！'
